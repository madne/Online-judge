...
$sql = "SELECT * FROM $database_name.audio_events WHERE date >= '$corrent_day' and date <= '$last_date' ";
...
<div id="contain">
  ...
  <div id="msg"></div>
 <center>
  <form class="form-inline" role="form" action="process_demand_audio.php" method="post">  
